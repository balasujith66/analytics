...
?class
(v2 = c(1,2,3)) #rouund braket create and print
v2
class(v2)
...
(v4 = 100:200)
1.100000000
length(v4) #no of items in vectoor
v4
v5 = seq(1,10,2)
...
(taxia = 100:105)
names(taxila)
names(taxila) = c('sat','suj','h','hhhh','kj')
...
1:24  #seq of values
(matrix1 = matrix(1:24, ncol=6, byrow=F))
length(1:24)
matrix1[,4]  #first columns
